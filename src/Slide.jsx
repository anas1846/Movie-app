...
import moneyImg from './assets/monyheist.png'
import sqaidImg from './assets/squidgame.jpg'
import thumbImg from './assets/thumb.png'
import lusiferImg from './assets/lusifer.png'
import strangerImg from './assets/25038.jpg'
...
export default function MovieSlider() {
  ...
  const data = [
    { title: "Blackbird", episode: "S04 EP03", img: moneyImg },
    { title: "La familia", episode: "S01 EP06", img: sqaidImg },
    { title: "The Detective", episode: "S02 EP02", img:  thumbImg},
    { title: "Dark World", episode: "S03 EP01", img: lusiferImg },
    { title: "Lost City", episode: "S02 EP08", img: strangerImg }
  ];
          ...
          {sliderData.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-red-600 w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl">
                  ▶
                </div>
              </div>
